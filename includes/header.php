...
<header class="fixed top-0 w-full bg-white/95 backdrop-blur-sm border-b z-50">
    <div class="container mx-auto flex justify-between items-center py-4 px-4 lg:px-8">
        <a href="<?php echo $path; ?>index.php"><img src="<?php echo $path; ?>assets/images/GNA Dental/Icons/logo.png"
                alt="Gnathos Dental" class="h-12"></a>
        <nav class="hidden lg:flex space-x-8 items-center">
            <a href="<?php echo $path; ?>index.php" class="<?php echo isActive('index.php', $current_page); ?>">Home</a>
            <a href="<?php echo $path; ?>about.php" class="<?php echo isActive('about.php', $current_page); ?>">About
                Us</a>
            <div class="relative group">
                <a href="#" class="text-gray-600 hover:text-gnathos font-medium flex items-center gap-1">Our Services
            ...
            <a href="https://gnathosdental.in/blogs/" target="_blank" class="text-gray-600 hover:text-gnathos">Blog</a>
            <a href="<?php echo $path; ?>contact.php"
                class="<?php echo isActive('contact.php', $current_page); ?>">Contact Us</a>
        </nav>
    ...
    <div id="mobile-menu" class="lg:hidden hidden bg-white border-t">
        <div class="container mx-auto px-4 py-4 space-y-4">
            ...
            <a href="<?php echo $path; ?>about.php" class="block text-gray-600 hover:text-gnathos font-medium">About
                Us</a>
            <div class="space-y-2">
                <p class="font-semibold text-gray-800">Our Services</p>
                <a href="<?php echo $path; ?>dental-implant.php"
                    class="block text-gray-600 hover:text-gnathos text-sm pl-4">Dental
                    Implant</a>
                <a href="<?php echo $path; ?>root-canal.php"
                    class="block text-gray-600 hover:text-gnathos text-sm pl-4">Root Canal</a>
                <a href="<?php echo $path; ?>dental-crowns.php"
                    class="block text-gray-600 hover:text-gnathos text-sm pl-4">Dental Crowns & Bridges</a>
                <a href="<?php echo $path; ?>oral-surgeries.php"
                    class="block text-gray-600 hover:text-gnathos text-sm pl-4">Oral
                    Surgeries</a>
                <a href="<?php echo $path; ?>wisdom-tooth-removal.php"
                    class="block text-gray-600 hover:text-gnathos text-sm pl-4">Wisdom
                    Tooth Removal</a>
                <a href="<?php echo $path; ?>general-dentistry.php"
                    class="block text-gray-600 hover:text-gnathos text-sm pl-4">General
                    Dentistry</a>
                <a href="<?php echo $path; ?>laser-dentistry.php"
                    class="block text-gray-600 hover:text-gnathos text-sm pl-4">Laser
                    Dentistry</a>
                <a href="<?php echo $path; ?>aligners.php"
                    class="block text-gray-600 hover:text-gnathos text-sm pl-4">Aligners</a>
            </div>
            <a href="https://gnathosdental.in/blogs/" target="_blank"
                class="block text-gray-600 hover:text-gnathos font-medium">Blog</a>
            <a href="<?php echo $path; ?>contact.php" class="block text-gray-600 hover:text-gnathos font-medium">Contact
                Us</a>
